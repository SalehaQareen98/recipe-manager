...
(1, 'Rob', 'Rob@gmail.com', 'password_1'),
(2, 'Steve', 'Steve@gmail.com', 'password_2');
...
CREATE TABLE IF NOT EXISTS `recipes` (
  ...
  `Favourites` tinyint(1) DEFAULT 0, -- New column for marking favourite recipes
  `Image` longblob NOT NULL, -- Store the uploaded image in binary format
